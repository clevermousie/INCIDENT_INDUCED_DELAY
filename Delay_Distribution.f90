...
module file_variables
    ...
    character(len=30) ::filename_output="./log/delay_distribution.txt"
    end module
module variables
    integer i,j,k
    integer station_num
            ...
            do j = 1, station_num
                ...
                do i = 1, day_count
                    ...
                    if (target_check(i).eq.0) then
                            ...
                            write(fileid_output,*) target_dow(i),target_mod(i),station_id(j),target_doy(i),TARGET_DELAY,real_day_count            
